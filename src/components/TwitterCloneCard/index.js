        ...
        <div>
            <Card className="card-body" style={{ width: '18rem' }}>
                ...
                <Card.Body>
                    ...
                    <Button className="card-buttons" href="https://github.com/Ramong06/twitter-clone" rel="noreferrer" target="_blank">GitHub Repo</Button>
                    <div className="button-divider" />
                    <Button className="card-buttons" href="https://twitter-clone5488.netlify.app/" rel="noreferrer"  target="_blank">Live Site</Button>
                </Card.Body>
            </Card>
        </div>
    )
